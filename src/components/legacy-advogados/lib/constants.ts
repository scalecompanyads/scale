...
/** Prints de conversas (prova social). Carrossel na seção de depoimentos: 1 slide no mobile, 3 no desktop. */
export const TESTIMONIAL_SCREENSHOTS: string[] = Array.from({ length: 19 }, (_, i) => {
  const n = String(i + 1).padStart(2, "0");
  return `/images/testimonials/testimonial-${n}.png`;
});

/** URLs de embed dos depoimentos em vídeo (YouTube, Vimeo, etc.). No desktop aparecem lado a lado; no mobile, empilhados. */
...
// TODO: substituir pelo número real da Scale Company
