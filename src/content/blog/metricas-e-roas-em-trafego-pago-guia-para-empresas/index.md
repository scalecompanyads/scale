...
<figure class="blog-figure-icon">
  <span class="blog-icon" aria-hidden="true">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 3v18h18"/><path d="M7 16l4-4 4 4 6-6"/></svg>
  </span>
  <figcaption>Antes do detalhe: defina o objetivo da campanha — a métrica “certa” depende disso.</figcaption>
</figure>
...
<figure class="blog-figure-icon">
  ...
  <figcaption>CTR e CPC ajudam a ajustar criativo e segmentação; não substituem análise de conversão.</figcaption>
</figure>
