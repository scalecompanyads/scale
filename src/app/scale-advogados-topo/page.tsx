...
import './scale-advogados-topo.css';
...
export default function ScaleAdvogadosTopoPage() {
  useEffect(() => {
      ...
      if (submitBtn) {
        submitBtn.addEventListener('click', function() {
          ...
          var payload = Object.assign({
            ...
            origem: 'scale-advogados-topo-modal',
            form_name: 'scale_advogados_topo_lp',
            pagina: '/scale-advogados-topo',
